...
public partial class Add_GitHubAccessToken : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("pk_git_hub_access_token", x => x.id);
                table.ForeignKey(
                    name: "fk_git_hub_access_token_users_user_id",
                    column: x => x.user_id,
        ...
        migrationBuilder.CreateIndex(
            name: "ix_git_hub_access_token_user_id",
            schema: "dev_habit",
            table: "git_hub_access_token",
            column: "user_id",
            unique: true);
    }
